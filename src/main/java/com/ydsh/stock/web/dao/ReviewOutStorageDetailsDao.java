/**
 * @filename:ReviewOutStorageDetailsDao 2019-06-12 11:57:58
 ...
 * <p>自定义mapper写在这里</p>
 * 
 * <p>说明： 出库单申请子表（明细）数据访问层</p>
 * @version: V1.0
 * @author: <a href=mailto:yangyanrui@yidianlife.com>xiaoyang</a>
 * 
 */
@Mapper
public interface ReviewOutStorageDetailsDao extends BaseMapper<ReviewOutStorageDetails> {
