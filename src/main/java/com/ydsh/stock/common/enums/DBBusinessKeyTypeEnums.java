...
public enum DBBusinessKeyTypeEnums {
    ...
    /**
     * 平台卡券活动模版编号：activity of Platform   AP+年份日期+六位数字递增  AP20181225000001
     **/
    AP(1000000, 999999L, "%06d", true),
    /**
     * 客户卡券活动编号：activity    A+年份日期+六位数字递增  A20181225000001
     **/
    A(1000000, 999999L, "%06d", true),
    /**
